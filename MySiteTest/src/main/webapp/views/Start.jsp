...
<body>
	<div align="center">
		<form name="reg" id="form" action="<c:url value="/StartServlet"/>" method="Post" onsubmit='return valid()'>
			<fieldset title="Ввод данных">
				...
				<br > <a href= "<c:url value="/views/Registration.jsp"/>"> Зарегистрироваться</a>
			</fieldset>
		</form>
	</div>
